...
//   is this supposed to be like this??
   ...
   @Test
   public void testStringWithMultipleQuotes() {
       runtest("\"He said, \\\"Hello!\\\"\"",
           new Token(STRING_LITERAL, 0, 0, "He said, \\"),
           new Token(ID, 0, 12, "Hello"),
           (Token)null,
           (Token)null,
           new Token(STRING_LITERAL,0,19,""),
           new Token(EOF, 0, 21, "")
       );
   }
   @Test
   ...
   @Test
   public void testNestedStringEscapes() {
       runtest("\"\\\"nested\\\"\"",
           new Token(STRING_LITERAL, 0, 0, "\\"),
           new Token(ID, 0, 3, "nested"),
           (Token)null,
           new Token(STRING_LITERAL,0,10,""),
           new Token(EOF, 0, 12, "")
       );
   }
}
